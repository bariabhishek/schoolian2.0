...
import com.wikav.schoolian.AcceptedActivity;
import com.wikav.schoolian.R;
import com.wikav.schoolian.SessionManger;

public class AcceptedListAdaptor extends RecyclerView.Adapter<AcceptedListAdaptor.ViewHolder> {

    Context context;
    List <ModelList> list;
    SessionManger sessionManger;
    String job_giver_mobile;
    public AcceptedListAdaptor(Context context, List <ModelList> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int i) {
        ...
        Toast.makeText(context, "No post accepted", Toast.LENGTH_SHORT).show();
